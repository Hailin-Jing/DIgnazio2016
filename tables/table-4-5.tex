\begin{table*}[!htb]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \caption{Basic statistics of 10 dimensionless soil parameters in F-CLAY/10/216, derived from the seven basic parameters in F-CLAY/7/216.}
        \addtocounter{table}{-1}
        \vspace{-8pt}
        \renewcommand{\tablename}{表}
        \caption{从F-CLAY/7/216中的七个基本参数得出的F-CLAY/10/216中的10个无因次土体参数的基本统计信息。}
        \vspace{4pt}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \caption{Basic statistics of 10 dimensionless soil parameters in F-CLAY/10/168, derived from the seven basic parameters in F-CLAY/7/168.}
        \addtocounter{table}{-1}
        \vspace{-8pt}
        \renewcommand{\tablename}{表}
        \caption{从F-CLAY/7/168中的七个基本参数得出的F-CLAY/10/168中的10个无因次土体参数的基本统计信息。}
        \vspace{4pt}
        \renewcommand{\tablename}{Table}
        \setlength{\tabcolsep}{1.5mm}{
        \begin{tabularx}{\textwidth}{lXXXXX}
