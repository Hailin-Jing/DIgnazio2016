...
\begin{table*}[!htb]
    \centering
    \footnotesize
    \caption{Transformation models in literature and their calibration results for F-CLAY/10/216.}
    \addtocounter{table}{-1}
    \vspace{-8pt}
    \renewcommand{\tablename}{表}
    \caption{文献中的转换模型及其对F-CLAY/10/216的校准结果。}
    \vspace{4pt}
    ...
    \begin{tabular}{lllllllll}
        ...
        B       & \RelationshipBA & \LiteratureBA & 694  & \ModelBA &  Fig.\ref{figure:12}a    & YES      & 2.02      & 0.94 \\
                & \RelationshipBB & \LiteratureBB & 492  & \ModelBB &  Fig.\ref{figure:12}a    & YES      & 0.95      & 0.47 \\
        C       & \RelationshipCA & \LiteratureCA & 1072 & \ModelCA &  Fig.\ref{figure:5}      & YES      & 0.95      & 0.28 \\
                ...
                & \RelationshipCC & \LiteratureCC & 1402 & \ModelCC &  Fig.\ref{figure:6}a     & YES      & 0.77      & 0.32 \\
